...
type private SpotPriceLevelsProvider = JsonProvider<spotPriceLevelsSample>

let private spotPriceLevelsConfig = "/config/ha/energy_manager/spotpricelevels.json"
let private configJson = System.IO.File.ReadAllText(spotPriceLevelsConfig);
let private data = SpotPriceLevelsProvider.Parse(configJson)

let levels = [ Free; Cheap; Normal; Expensive; Extreme; ] 
